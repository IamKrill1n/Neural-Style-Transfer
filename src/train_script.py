...
import nst_torch.utils as utils
from nst_torch.transformer_net import TransformerNet
from nst_torch.vgg import Vgg16
...
def main():
    ...
    train_arg_parser.add_argument("--style-image", type=str, default="style_images/starry_night.jpg",
